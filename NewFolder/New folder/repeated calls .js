...
function rcMapRow(it) {
    ...
    return {
        ...
        rcStatus: rcCallerDisplayStatus(it) || '—',
...
window.rcExportPpt = async function () {
    ...
    try {
        ...
        [
            ...
            ['In Progress (not edited)', tree.inProgress],
    ...
    try {
        ...
        y = rcPdfTable(pdf,
            ...
            [
                ...
                ['In Progress (not edited)', tree.inProgress, 'No Call Back Status saved yet'],
